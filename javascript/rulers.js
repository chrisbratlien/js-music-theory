...
BSD.Ruler = function(spec) {
  ...
  var wrap = jQuery('<div class="ruler"></div>');    
  ...
  */
  ...
  self.renderOn = function(html) {
    ...
    spec.items.reverse().each(function(item) {
      ...
      ///div.html(item.name);
      //item.names.each(function(n) { div.append(n + '<br />'); });
        ...
        //hoverdiv.css('top',400);
        //hoverdiv.css('left',400);
