...
export function makeFretboardOn(wrap, opts) {
    ...
    let abstractNoteValues = (chord && chord.abstractNoteValues()) || [];
    var newData = defaultData.map(function(o) {
        var hit = abstractNoteValues.detect(function(av) {
            ...
            if (!activeStrings.detect(function(s) {
                    return o.string == s;
                })) {
                return false;
            }
