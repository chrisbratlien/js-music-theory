  ...
  <script src="<?php bloginfo('url'); ?>/lib/jquery-1.11.2.min.js"></script>
  <script src="<?php bloginfo('url'); ?>/lib/jquery-migrate-1.2.1.min.js"></script>
  <script src="<?php bloginfo('url'); ?>/lib/jquery-ui.js"></script>
  ...
  <script src="<?php bloginfo('url'); ?>/js/bsd.widgets.baseplayer.js"></script>
  <script src="<?php bloginfo('url'); ?>/js/bsd.widgets.stringoscillator.js"></script>
  <script src="<?php bloginfo('url'); ?>/js/bsd.widgets.guitarplayer.js"></script>
  ...
  <script src="<?php bloginfo('url'); ?>/js/main.js" type="module" onload="onAppLoad()"></script>
